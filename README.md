...
This is a demo showing the basics of how to utilize OpenZepplin to create transparent proxy style upgradeable smart contracts. 

Watch this YouTube video (link after video goes live) for a guided walkthrough and explanation.

This repo was forked from the [Chainlink Hardhat Starter Kit](https://github.com/smartcontractkit/hardhat-starter-kit) and includes all of it's boiler plate code.
